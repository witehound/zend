    ...
    <main className=" flex">
      ...
      <section className="p-5 flex-1 gap-5 flex flex-col">
        ...
        <div className="flex w-full gap-5">
          <div className="bg-[#181818] p-10 flex-1 flex flex-col gap-5 rounded-[10px]">
            <h2 className=" text-[20px] text-[#7B7B7B]">My Balance</h2>
            <h1 className=" text-[40px]">$100,000</h1>
            <p className=" text-[#1FDD00]">View activities</p>
          </div>
          <div className="bg-[#1818] p-10 flex-1 flex flex-col gap-5 rounded-[10px]">
            <h2 className=" text-[20px] text-[#7B7B7B]">My Balance</h2>
            <h1 className=" text-[40px]">$100,000</h1>
          </div>
        </div>
